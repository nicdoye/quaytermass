...
type APIErrorDescription struct {
	...
	// Required: true
	// Enum: [downstream_issue exceeds_license expired_token external_service_timeout fresh_login_required insufficient_scope invalid_request invalid_response invalid_token not_found]
