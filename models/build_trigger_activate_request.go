...
func (m *BuildTriggerActivateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BuildTriggerActivateRequest) UnmarshalBinary(b []byte) error {
	var res BuildTriggerActivateRequest
