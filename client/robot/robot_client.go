...
*/
func (a *Client) CreateOrgRobot(params *CreateOrgRobotParams, authInfo runtime.ClientAuthInfoWriter) (*CreateOrgRobotOK, *CreateOrgRobotCreated, error) {
	...
	case *CreateOrgRobotOK:
		return value, nil, nil
	case *CreateOrgRobotCreated:
